...
func HTTPRequestDecoder(file file.File, service types.Service, method types.Method) error {
...
func HTTPResponseDecoder(file file.File, service types.Service, method types.Method) error {
	file.AddImport("", "context")
	file.AddImport("", "net/http")
	methodName := strings.ToUpperFirst(method.Name)
